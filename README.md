...
Generating naivebayes data to disk:
	...
	$spark-submit --jars lib/jopt-simple-4.9-beta-1.jar --class "bsc.spark.perf.mllib.TestRunner" --master local[4] target/bsc.spark-1.4.1.jar naive-bayes-gen -path file:///gpfs/projects/bsc31/bsc31550/data -num-trials 1 -inter-trial-wait 3 -num-partitions 400 -random-seed 5 -num-examples 100000 -num-features 10000 -nb-lambda 1.0 -per-negative 0.3 -scale-factor 1.0

Executing naivebayes over disk data:

	$spark-submit --jars lib/jopt-simple-4.9-beta-1.jar --class "bsc.spark.perf.mllib.TestRunner" --jars bsc.spark.1.4.3/lib/jopt-simple-4.9-beta-1.jar --master local[4] bsc.spark-1.4.4.jar naive-bayes-disk -path file:///gpfs/projects/bsc31/bsc31550/data -num-trials 1 -inter-trial-wait 3 -num-partitions 400 -random-seed 5 -num-examples 100000 -num-features 10000 -nb-lambda 1.0 -per-negative 0.3 -scale-factor 1.0
